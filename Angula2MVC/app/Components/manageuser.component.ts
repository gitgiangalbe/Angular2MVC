...
export class ManageUser implements OnInit {
    ...
    constructor(private fb: FormBuilder, private _userService: UserService, public dialogRef: MatDialogRef<ManageUser>) { }
    ...
    ngOnInit(): void {
        ...
        this.filteredStates = this.userFrm.controls["State"].valueChanges.map((name) => this.filterStates(name));
