...
var ManageUser = /** @class */ (function () {
    ...
    ManageUser.prototype.ngOnInit = function () {
        ...
        this.filteredStates = this.userFrm.controls["State"].valueChanges.map(function (name) { return _this.filterStates(name); });
        // value = 25
        // myFormGroup.value = { length: 25 }
        //});
        //.startWith(null).map(
        //(name) => this.filterStates(name));
    ...
    ManageUser = __decorate([
        ...
        __metadata("design:paramtypes", [forms_1.FormBuilder, user_service_1.UserService, material_1.MatDialogRef])
    ], ManageUser);
    return ManageUser;
}());
